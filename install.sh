...
get_node_url(){
	...
	nodes=(http://dg2.bt.cn http://dg1.bt.cn https://download.bt.cn);
...
Install_Bt(){
	...
	wget -O panel.zip https://raw.githubusercontent.com/uboard/panel/master/panel.zip -T 10
...
Setup_Count(){
	echo ok > /www/server/panel/data/o.pl
	cd /www/server/panel
